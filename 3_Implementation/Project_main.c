...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Free Guy\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 30-05-2018\n");
        printf("\t                                              Time      : 06:30pm\n");
        printf("\t                                              Hall      : 01\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for Free Guy\n\n");
	printf("\t\t\tpress 2 for Spiderman\n\n");
	printf("\t\t\tpress 3 for Dr.Strange\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------MOVIE TICKET BOOKING----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Spiderman \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 16-05-2018\n");
        printf("\t                                              Time      : 07.30pm\n");
        printf("\t                                              Hall      : 02\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------MOVIE TICKET BOOKING----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Dr.Strange \n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 15-08-2018\n");
        printf("\t                                              Time      : 08.30:00pm\n");
        printf("\t                                              Hall      : 03\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
        person[count].id=id2;
